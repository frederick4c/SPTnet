...
def main():
    ...
    if isinstance(filename_train, tuple):
        ...
        training_files = filename_train if isinstance(filename_train, list) else [filename_train]
    max_dim = 0
    ...
    spt.data_loader(data_train, [train_size, val_size])  # train_set, data_test, split training data for validation [train, val].
