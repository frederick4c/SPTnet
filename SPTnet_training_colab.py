    ...
    def hungarian_matched_loss(pred_classes, pred_positions, pred_H, pred_C, gt_classes, gt_positions, gt_H, gt_C):
        ...
        for b in range(num_batches):
            ...
            if num_tracks != 0:
                ...
                CRLBweight_H = CRLB_matrix[0, 0, stepidx, H_idx, C_idx] / (CRLB_matrix[0, 0, spt.number_of_frame-1, H_idx, C_idx] + 1e-8)
                CRLBweight_C = CRLB_matrix[1, 1, stepidx, H_idx, C_idx] / (CRLB_matrix[1, 1, spt.number_of_frame-1, H_idx, C_idx] + 1e-8)
